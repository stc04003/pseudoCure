...
extern SEXP _pseudoCure_fastDabrowska_vec(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _pseudoCure_fastTau(SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_pseudoCure_fastDabrowska_vec", (DL_FUNC) &_pseudoCure_fastDabrowska_vec,  7},
    {"_pseudoCure_fastTau",           (DL_FUNC) &_pseudoCure_fastTau,            4},
